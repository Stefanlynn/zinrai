      ...
      <TooltipProvider>
        ...
        <div className="fixed top-0 left-0 right-0 h-[32px] bg-[#f7f5f0] z-[1000] flex items-center">
          ...
          <div className="relative z-10" ref={menuRef}>
            ...
            {/* Completely redesigned menu - ultra high visibility with dramatic styling */}
            {menuOpen && (
              <div className="fixed inset-0 bg-white z-[1001] overflow-auto">
                {/* Header with close button - now black on white for contrast */}
                <div className="w-full py-6 px-8 flex justify-between items-center bg-black">
                  <h1 className="text-white text-3xl font-bold tracking-wide">ZiNRAi</h1>
                ...
                {/* Main navigation - now very large and bold */}
                <div className="py-8 px-8 bg-white">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <a 
                      className="bg-black text-white p-6 text-center text-2xl md:text-3xl font-bold rounded-lg shadow-lg hover:bg-gray-900 transition-colors"
                      onClick={() => {
                        setLocation('/product');
                        toggleMenu();
                      }}
                ...
                {/* Info Center with high contrast grid */}
                <div className="bg-black py-10 px-8">
                  <h2 className="text-white text-2xl font-bold mb-8 text-center">INFO CENTER</h2>
                  
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                    {/* Terms & Policies */}
                    <div className="bg-white p-6 rounded-lg shadow-lg">
                      <h3 className="text-black text-xl font-bold mb-4">Terms & Policies</h3>
                      <div className="flex flex-col space-y-3">
                        <a href="#" className="text-black text-base font-medium hover:underline">IBO Terms</a>
                        <a href="#" className="text-black text-base font-medium hover:underline">Member Terms</a>
                        <a href="#" className="text-black text-base font-medium hover:underline">Policies & Procedures</a>
                        <a href="#" className="text-black text-base font-medium hover:underline">Refund Policy</a>
                        <a href="#" className="text-black text-base font-medium hover:underline">Income Disclosure</a>
                      </div>
                    </div>
                    
                    {/* Legal & Regional */}
                    <div className="bg-white p-6 rounded-lg shadow-lg">
                      <h3 className="text-black text-xl font-bold mb-4">Legal & Regional</h3>
                      <div className="flex flex-col space-y-3">
                        <a href="#" className="text-black text-base font-medium hover:underline">Japan Information</a>
                        <a href="#" className="text-black text-base font-medium hover:underline">Global Compliance Notice</a>
                      </div>
                    </div>
                    
                    {/* Privacy & Usage */}
                    <div className="bg-white p-6 rounded-lg shadow-lg">
                      <h3 className="text-black text-xl font-bold mb-4">Privacy & Usage</h3>
                      <div className="flex flex-col space-y-3">
                        <a href="#" className="text-black text-base font-medium hover:underline">Privacy Policy</a>
                        <a href="#" className="text-black text-base font-medium hover:underline">Terms of Use</a>
                        <a href="#" className="text-black text-base font-medium hover:underline">Employee Privacy</a>
                      </div>
                    </div>
                    
                    {/* Support */}
                    <div className="bg-white p-6 rounded-lg shadow-lg">
                      <h3 className="text-black text-xl font-bold mb-4">Support</h3>
                      <div className="flex flex-col space-y-3">
                        <a 
                          href="/contact" 
                ...
                {/* Footer */}
                <div className="bg-white py-6 px-8 border-t border-gray-200">
                  <div className="container mx-auto">
                    <div className="flex flex-col md:flex-row justify-between items-center">
                      <div className="text-black mb-4 md:mb-0 font-medium">
