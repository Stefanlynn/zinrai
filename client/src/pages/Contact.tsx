    ...
    <div className="bg-black min-h-screen w-full overflow-y-auto">
      <div className="w-full">
        ...
        <section className="relative h-screen w-full">
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center max-w-md px-4 z-20">
            ...
            <button 
              className="bg-black border border-white/50 hover:border-white text-white py-3 px-8 transition-all duration-300 focus:outline-none hover:bg-white/10"
