...
export default function Home() {
  ...
  // Video sources - all five videos for the grid
  const videoSources = [tradingVideo, viennaVideo, runningVideo, familyTravelVideo, coastlineVideo];
  ...
  useEffect(() => {
    ...
    const boxPositions = [2, 3, 4, 5, 6]; // Top-right, center-left, center-right, bottom-left, and bottom-right boxes
      ...
      <div className="fixed inset-0">
        ...
        <div className="absolute top-[55%] left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-40 w-full px-4 text-center">
          <div className="relative inline-block">
            ...
            <h1 className="zinrai-logo-text text-white text-[14vw] md:text-[10vw] lg:text-[8vw] xl:text-[120px] font-bold tracking-wider whitespace-nowrap relative z-10 neon-text-glow">
              ZiNRAi
            </h1>
          </div>
        </div>
