    ...
    <div className="bg-black min-h-screen">
      ...
      <div className="relative z-10 pb-16 overflow-auto" style={{ height: "100vh" }}>
        <div className="flex flex-col md:flex-row p-4">
          ...
          <div className={`hidden md:block w-1/2 p-16 pt-[240px] pb-20 pr-20 transition-all duration-700 ${animatedIn ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-5'}`}>
