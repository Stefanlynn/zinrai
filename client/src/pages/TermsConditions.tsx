    ...
    <div className="min-h-screen bg-black text-white overflow-y-auto">
      ...
      <div className="container mx-auto px-6 py-12 max-w-4xl">
        ...
        <div className="prose prose-invert max-w-none space-y-6 text-sm leading-relaxed">
          ...
          <h3 className="text-xl font-semibold mt-6 mb-3 text-blue-300">B. Alternative Arbitration</h3>
          <p>In the event the AAA is unwilling or unable to hear the dispute, the Parties shall agree to, or an appropriate court shall select, another arbitration provider. Unless otherwise agreed upon by the Parties, any arbitration hearing shall take place in Sheridan, Wyoming, although either party may elect to participate in the arbitration by telephone. The Party filing the Demand for Arbitration shall be responsible for the initial filing fees and costs charged by AAA and the respondent shall be responsible for payment of filing fees for any Cross-Complaint or Counterclaim.</p>

          <h3 className="text-xl font-semibold mt-6 mb-3 text-blue-300">C. Third Party Beneficiaries</h3>
          <p>Although this agreement to arbitrate is made and entered into between You and ZiNRAi, ZiNRAi's affiliates, owners, members, managers, and employees ("Related Parties") are intended third party beneficiaries of the Member Terms and Conditions including this agreement to arbitrate.</p>

          <h3 className="text-xl font-semibold mt-6 mb-3 text-blue-300">D. Survival and Process</h3>
          <p>This agreement to arbitrate shall survive the termination of the Membership and the Member's ZiNRAi account. Any issues related to the arbitrability of any claim, or the scope, validity or enforceability of this agreement to arbitrate shall be determined by the arbitrator. If either party wishes to initiate arbitration, the initiating party must notify the other party in writing via certified mail, return receipt requested, or hand delivery via courier. The Demand for Arbitration must include a statement of the legal and factual basis of the claim(s) to be arbitrated. You will send a copy of any demand for arbitration to ZiNRAi by certified mail addressed to ZiNRAi, LLC, 30 Gould Street, Sheridan Wyoming 82801. ZiNRAi will send any demand for arbitration to You by certified mail using the current mailing address You provided in Your ZiNRAi Member enrollment or in Your Member profile, if updated. The parties shall be entitled to all discovery rights permitted by the Federal Rules of Civil Procedure and the parties shall be permitted to bring motions under FRCP Rules 12 and 56. The decision of the arbitrator shall be final and binding on the parties and may, if necessary, be reduced to a final judgment in a court of competent jurisdiction.</p>

          <h3 className="text-xl font-semibold mt-6 mb-3 text-blue-300">E. Required Informal Dispute Resolution</h3>
          <p>Except for IP Claims (defined in Section F) and Claims requiring a temporary restraining order, if either of Us has a Claim against the other, both of Us must first attempt to resolve the Claim informally before the Claim may be brought in arbitration. You and ZiNRAi will make a good-faith effort to negotiate for forty-five (45) days towards the resolution of any Claim, or for a longer period as mutually agreed in writing by You and ZiNRAi. You will send any Claimant Notice to ZiNRAi by certified mail addressed to ZiNRAi, LLC, 30 Gould Street, Sheridan Wyoming 82801. ZiNRAi will send any Claimant Notice to You by certified mail using the current mailing address You provided in Your ZiNRAi Member profile. The Claimant Notice sent by either party must provide factual information sufficient for the receiving party to evaluate the Claim and must include the claimant's name, address, email address, and any relevant purchase information and product information. Engaging in Informal Dispute Resolution is a condition precedent to either party's right to initiate an arbitration.</p>

          <h3 className="text-xl font-semibold mt-6 mb-3 text-blue-300">F. Claims Subject to Binding Arbitration; Exceptions</h3>
          <p>Except for IP Claims, which are disputes that exclusively relate to infringement of Your or ZiNRAi's intellectual property rights, both parties agree that all Claims meeting the requirements of Section E that are not resolved during the Informal Resolution Period, including Claims that are unrelated to IP Claims but are jointly filed with IP Claims, will only be resolved through binding arbitration.</p>

          <h3 className="text-xl font-semibold mt-6 mb-3 text-blue-300">G. Small Claims</h3>
          <p>You or ZiNRAi may pursue any Claim, except IP Claims, in a small-claims court instead of through arbitration if (i) the Claim meets the jurisdictional requirements of the small claims court and (ii) the small claims court does not permit class actions or similar representative actions or relief.</p>

          <h3 className="text-xl font-semibold mt-6 mb-3 text-blue-300">H. Arbitration Fees</h3>
          <p>You and ZiNRAi will each be responsible for paying the fees of the arbitrator and any administrative fees charged by AAA according to the rules and procedures of the AAA.</p>

          <h3 className="text-xl font-semibold mt-6 mb-3 text-blue-300">I. Frivolous or Improper Claims</h3>
          <p>To the extent permitted by law, a claimant must pay all reasonable costs and fees incurred by the responding party—including arbitration fees, attorney fees, and expert fees—related to a Claim if an arbitrator or court determines that (i) the Claim was not warranted by existing law or by a nonfrivolous argument or (ii) the Claim was filed in arbitration for any improper purpose, including to harass the responding party, cause unnecessary delay, or increase the cost of dispute resolution.</p>

          <h3 className="text-xl font-semibold mt-6 mb-3 text-red-300">J. Class Action Waiver</h3>
          <div className="bg-red-900/20 border border-red-500/30 p-4 rounded-lg">
            <p>You and ZiNRAi agree that by entering into the above agreement to arbitrate both parties are waiving their right to have any dispute or claim brought, heard or arbitrated as a class action lawsuit or class action arbitration, or any joint or consolidated lawsuit or joint or consolidated arbitration of any kind. You and ZiNRAi agree that an arbitrator shall not have any authority to hear or arbitrate any class or collective action. You and ZiNRAi agree that any claim that all or part of this class action waiver is unenforceable shall be determined by a state or federal court located in Sheridan, Wyoming and not by an arbitrator. You and ZiNRAi further agree that if a court determines that the limitations of this paragraph are deemed invalid or unenforceable, any putative class or representative action must be brought in a court of proper jurisdiction and not in arbitration.</p>
          </div>

          <h3 className="text-xl font-semibold mt-6 mb-3 text-blue-300">K. Mass Arbitrations</h3>
          <p>If twenty-five (25) or more Claimant Notices are received by a party within one hundred and eighty (180) days of the first Claimant Notice that the party received, and all such Claimant Notices raise similar Claims and have the same or coordinated counsel, then these Claims will be considered "Mass Arbitrations." You or ZiNRAi may advise the other if You or ZiNRAi believe that the Claims at issue are Mass Arbitrations, and disputes over whether a Claim meets the definition of "Mass Arbitrations" will be decided by the arbitration provider as an administrative matter. Mass Arbitrations shall proceed pursuant to the AAA Mass Arbitration procedures.</p>
          ...
          <h3 className="text-xl font-semibold mt-6 mb-3 text-blue-300">M. Governing Law</h3>
          <p>All Claims shall be subject to, governed by, construed, and interpreted in accordance with the laws of the State of Wyoming, U.S.A., except for its conflict of law rules. The Federal Arbitration Act shall otherwise govern all matters relating to arbitration.</p>

          <h3 className="text-xl font-semibold mt-6 mb-3 text-blue-300">N. Venue</h3>
          <p>All Claims not subject to arbitration pursuant to these Dispute Resolution Terms and that cannot be heard in small claims court will be resolved exclusively and have jurisdiction in the courts located in Sheridan, Wyoming, U.S.A.</p>
          ...
          <p>We reserve the right, in Our sole discretion, to approve or deny the reactivation of a canceled Membership. If You apply to reactivate a canceled Membership within six (6) months of cancellation, Your account may only be reactivated with the same BP enroller as Your prior Membership.</p>

          <p>You may cancel Your Membership by emailing support@zinrai.com or using the cancellation option in Your back office.</p>

          <p>The following sections survive termination of these Member Terms and Conditions: Intellectual Property; User Accounts, Comments and Ideas; Limitation of Liability, Indemnification; Disputes & Arbitration; Privacy and Your Personal Data and Applicable Law.</p>

          <h2 className="text-2xl font-bold mt-8 mb-4 text-blue-300">Privacy and Your Personal Data</h2>
          <p>You understand and acknowledge that You and Your activity as a Member are subject to the ZiNRAi Privacy Policy and Terms of Use, which are incorporated into and a material part of these Member Terms and Conditions. You acknowledge that You have read and understand the Privacy Policy, and the Terms of Use and consent to the use of any personal information that You provide according to these Member Terms and Conditions and the Privacy Policy. When You disclose personal data as part of the Member enrollment process, as well as other personal data disclosed in conducting Your activities as a Member, You acknowledge that this information is necessary to allow ZiNRAi to fulfill its contractual obligations to You and the ZiNRAi network of Customers/Members, ZiNRAi BPs and suppliers, vendors and service providers. The data collected is used by ZiNRAi internal and authorized external service providers, suppliers and vendors taking part in the operation and management of the distribution network. You consent to the disclosure of Your name, telephone number(s), e-mail address(es), mailing address(es) and other contact information listed on Your online Member enrollment application or profile as updated, and information regarding Your ZiNRAi purchases (excluding Payment Method information), to internal departments, authorized service providers, Your sponsor, upline BPs and the ZiNRAi support team. You agree that ZiNRAi or a person acting on its behalf may contact You by telephone, text messaging, email, and other electronic communication channels. You consent and agree to being contacted in this manner at the telephone number(s) and email address(es) that You provide. Your carrier's standard rates will apply for calls and text messages. If You wish to opt out of promotional emails, You can unsubscribe from the ZiNRAi promotional email list by following the unsubscribe options in the promotional email itself, by emailing support@zinrai.com or by electing to unsubscribe in Your back office. You will continue to receive emails regarding business-related transactions regardless of the email subscriptions that are chosen. If You wish to opt out of promotional texts, You may do so by responding as indicated to allow for opting out on the text itself. You may opt out of promotional telephone calls by simply requesting to be placed on the ZiNRAi do not contact list. You may also opt out of texts by email at support@zinrai.com. You acknowledge that You are not required to consent to receive promotional, emails, texts or calls as a condition of being a Member.</p>

          <div className="bg-gray-800 p-4 rounded-lg">
            <p className="font-bold uppercase">BY SUBMITTING YOUR APPLICATION TO BECOME A MEMBER YOU AUTHORIZE ZiNRAi, ITS AFFILIATES, ITS SERVICE PROVIDERS, ZiNRAi BPS, AND REPRESENTATIVES, TO CONTACT YOU BY PHONE, MAIL, EMAIL AND VIA OTHER ELECTRONIC COMMUNICATION CHANNELS CONCERNING ZiNRAi RELATED MATTERS.</p>
          </div>

          <h2 className="text-2xl font-bold mt-8 mb-4 text-blue-300">General</h2>
          <p>These Member Terms and Conditions represent the complete agreement and understanding between You and Us and supersede all prior agreements and representations, commitments, or understandings, whether oral or written, made by or between You and Us with respect to the subject matter of these Member Terms and Conditions. In the event of a conflict between the terms and conditions contained in these Member Terms and Conditions, the Terms of Use and the Privacy Policy, the following order of precedence shall apply: first, (i) the Dispute Resolution Provisions, then (ii) these Member Terms and Conditions, then (iii) the ZiNRAi Privacy Policy and lastly (iv) the ZiNRAi Terms of Use.</p>

          <p>These Member Terms and Conditions do not, and shall not be construed to, create any partnership, joint venture, employer-employee, agency, or franchisor-franchisee relationship between You and us.</p>

          <p>Headings used in these Member Terms and Conditions are for reference purposes only and in no way define or limit the scope of the section.</p>

          <p>Subject to the Dispute Resolution Provisions, if any provision of these Member Terms and Conditions is determined by an authority of competent jurisdiction to be invalid or unenforceable in part or in whole for any reason whatsoever, the validity of the remaining provisions or portions thereof shall not be affected thereby, and such authority should reform these Member Terms and Conditions to the extent necessary in a manner that comes closest to expressing the intention of the invalid and unenforceable provision while rendering the otherwise unenforceable provision or portion thereof valid and enforceable.</p>

          <p>The failure by Us to act with respect to a breach of these Member Terms and Conditions by You or others does not constitute a waiver and will not limit Our rights with respect to such breach or any subsequent breaches.</p>

          <p>You may not assign, transfer, or sublicense any or all of Your rights or obligations under these Member Terms and Conditions without Our express prior written consent. We may assign, transfer, or sublicense any or all of Our rights or obligations under these Member Terms and Conditions at any time and without Your consent, and upon such assignment, ZiNRAi shall be relieved of any and all duties, obligations, and/or liabilities arising from these Member Terms and Conditions. These Member Terms and Conditions shall be binding upon and inure to the benefit of the heirs, successors, and permitted assigns of the parties hereto.</p>

          <p>Any use of the term "including" or variations thereof in these Member Terms and Conditions shall be construed as if followed by the phrase "without limitation."</p>

          <p>Notices to You (including notices of changes to these Member Terms and Conditions) may be made via posting to the Site or by e-mail (including in each case via links), or by regular mail. Without limitation, a printed version of these Member Terms and Conditions and of any notice given in electronic form shall be admissible in judicial or administrative proceedings based upon or relating to these Member Terms and Conditions to the same extent and subject to the same conditions as other business documents and records originally generated and maintained in printed form.</p>

          <h2 className="text-2xl font-bold mt-8 mb-4 text-blue-300">Additional Terms and Programs</h2>
          <p>We may from time to time and in Our discretion notify You of additional terms that may be incorporated into these Member Terms and Conditions that govern specific benefits, incentives and programs for Members.</p>

          <h2 className="text-2xl font-bold mt-8 mb-4 text-blue-300">Governing Law</h2>
          <p>These Member Terms and Conditions will be governed by and construed in accordance with the law of the State of Wyoming, without regard to principles of conflicts of laws. The parties consent to jurisdiction and venue before any federal or state court in Sheridan County, Wyoming, for purposes of enforcing an award by an arbitrator or any other matter not subject to arbitration.</p>
