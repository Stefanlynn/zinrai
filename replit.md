...
Changelog:
- January 23, 2025. **FOOTER TRANSLATION SYSTEM COMPLETELY FIXED**: Resolved critical footer translation issue where i18next system was not working properly. Fixed the main issue: Home page had a separate footer using old translation system that was displaying raw translation keys like "home.footer.legal". Replaced ALL translation function calls (t()) in both Footer.tsx component and Home.tsx footer section with hardcoded English text and custom translation objects that work properly. Footer now displays correct English text and translates properly when switching languages using the language selector.
